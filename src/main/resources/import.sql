...
INSERT INTO user(dtype, first_name, last_name, password, username) VALUES ('Guide', 'Lorenzo', 'Grigi', '123', 'l.grigi');
...
INSERT INTO tour(approx_cost, approx_duration, description, creation_date, is_public, title, guide_id, city_id, theme_id) VALUES (5.5, '02:30', 'Ho provato a fare del mio meglio', NOW(), TRUE, 'Si fa quel che si può', 3, 3, 3);
